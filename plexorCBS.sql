...
insert  into `plexSetting`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`type`,`setting`,`codename`,`value`,`value2`,`value3`,`status`,`sig`,`sig_status`) values (3,NULL,NULL,NULL,NULL,0,0,'MCHECKER','Posting Rules - Delete','POSTINGRULES_DELETE','yes','-1','admin@plexor.com',1,NULL,0);
insert  into `plexSetting`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`type`,`setting`,`codename`,`value`,`value2`,`value3`,`status`,`sig`,`sig_status`) values (4,NULL,NULL,NULL,NULL,0,0,'MCHECKER','Posting Rules - Insert','POSTINGRULES_INSERT','yes','-1','admin@plexor.com',1,NULL,0);
