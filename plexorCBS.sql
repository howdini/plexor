...
insert  into `plexMakerChecker`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`creator`,`stamp`,`document`,`document_id`,`trx_type`,`child_trx_type`,`values`,`checkers`,`check_status`,`checker_comments`,`posted_status`,`posted_result`,`parent`,`sig`,`sig_status`) values ('2808282024104155428698','2024-08-28 10:41:55.000000','2024-08-28 10:41:55.000000','Administrator','Administrator',0,0,'Administrator','2024-08-15 09:19:01.010987','PostingRules','Savings Deposits','UPDATE','-','{title :\"Savings Deposits\",\n description :\"Savings Deposits Tsken\"}','{admin@plexor.com: pending,\n}',0,NULL,0,NULL,NULL,'',0);
insert  into `plexMakerChecker`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`creator`,`stamp`,`document`,`document_id`,`trx_type`,`child_trx_type`,`values`,`checkers`,`check_status`,`checker_comments`,`posted_status`,`posted_result`,`parent`,`sig`,`sig_status`) values ('2808282024145635998160','2024-08-28 14:56:35.000000','2024-08-28 14:56:35.000000','Administrator','Administrator',0,1,'Administrator','2024-08-28 14:56:35.000000','PostingRulesAccounts','','UPDATE','INSERT','{\"child\":{postingRule :\"Savings Deposits\",\n type :\"Credit\",\n account :\"Loan Charges\"}}','{admin@plexor.com: pending,}',0,NULL,0,NULL,'Savings Deposits','',0);
insert  into `plexMakerChecker`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`creator`,`stamp`,`document`,`document_id`,`trx_type`,`child_trx_type`,`values`,`checkers`,`check_status`,`checker_comments`,`posted_status`,`posted_result`,`parent`,`sig`,`sig_status`) values ('2808282024145752922099','2024-08-28 14:57:52.000000','2024-08-28 14:57:52.000000','Administrator','Administrator',0,1,'Administrator','2024-08-28 14:57:52.000000','PostingRulesAccounts','46','UPDATE','DELETE','{\"parent\":{title :\"Savings Deposits\",\n description :\"Savings Deposits Tsken\"}, \"child\":{postingRule :\"Savings Deposits\",\n type :\"Debit\",\n account :\"Penalties\"}}','{admin@plexor.com: pending,}',0,NULL,0,NULL,'Savings Deposits','',0);
insert  into `plexMakerChecker`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`creator`,`stamp`,`document`,`document_id`,`trx_type`,`child_trx_type`,`values`,`checkers`,`check_status`,`checker_comments`,`posted_status`,`posted_result`,`parent`,`sig`,`sig_status`) values ('2808282024150410279876','2024-08-28 15:04:10.000000','2024-08-28 15:04:10.000000','Administrator','Administrator',0,1,'Administrator','2024-08-28 15:04:10.000000','PostingRulesAccounts','','UPDATE','INSERT','{\"child\":{postingRule :\"Savings Deposits\",\n type :\"Debit\",\n account :\"Loan Charges\"}}','{admin@plexor.com: pending,}',0,NULL,0,NULL,'Savings Deposits','',0);
...
insert  into `plexPostingRulesAccounts`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`postingRule`,`type`,`account`,`sig`,`sig_status`) values (62,NULL,NULL,NULL,NULL,0,0,'hward','Debit','Cashier Deposits',NULL,0);
insert  into `plexPostingRulesAccounts`(`name`,`creation`,`modified`,`modified_by`,`owner`,`docstatus`,`idx`,`postingRule`,`type`,`account`,`sig`,`sig_status`) values (64,NULL,NULL,NULL,NULL,0,0,'hward','Debit','Loan Charges',NULL,0);
